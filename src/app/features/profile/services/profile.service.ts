      ...
      tap({
        next: (data) => {
          ...
          const loaded: ProfileDTO = {
            ...
            business_banner_url: p.business_banner_url || null,
            featured_banner_url: p.featured_banner_url || null,
            business_address: p.business_address || null,
            business_state_id: p.business_state_id || null,
            business_district_id: p.business_district_id || '',
            business_pincode: p.business_pincode || null,
            primary_business_name: p.primary_business_name || null,
            primary_business_id: p.primary_business_id || null,
            primary_business_category_name: p.primary_business_category_name || null,
            primary_business_state_name: p.primary_business_state_name || null,
            primary_business_district_name: p.primary_business_district_name || null,
            primary_business_banner_url: p.primary_business_banner_url || null,
